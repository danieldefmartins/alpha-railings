...
export const metadata: Metadata = {
  title: "Glass & Iron Railings in Rhode Island | Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Rhode Island. Custom fabrication and installation in Providence, Warwick, Newport, and across the state. Free quotes.",
};
...
const counties = [
  ...
  {
    name: "Kent County",
    cities: ["Warwick", "Coventry", "East Greenwich"],
  },
  {
    name: "Newport County",
  ...
  },
  {
    ...
    cities: ["South Kingstown", "Narragansett", "Westerly"],
  },
  {
    name: "Bristol County",
    cities: ["Bristol", "Warren", "Barrington"],
  },
];
...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Fully licensed and insured for residential and commercial work throughout Rhode Island.",
  },
  {
...
const jsonLd = {
  ...
  name: "Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Rhode Island. Custom fabrication and professional installation.",
  url: "https://alpharailings.com/areas/rhode-island",
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-accent">Rhode Island</span>
            </h1>
            <p className="mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl">
              ...
              fabrication and installation throughout Rhode Island — from
              Providence to Newport and across the Ocean State.
            </p>
