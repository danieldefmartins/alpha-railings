...
export const metadata: Metadata = {
  title: "Glass & Iron Railings in Massachusetts | Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Massachusetts. Custom fabrication and installation in Boston, Cambridge, Everett, Worcester, and across the state. Free quotes.",
};
...
const counties = [
  ...
  {
    name: "Norfolk County",
    cities: ["Quincy", "Brookline", "Braintree", "Weymouth"],
  },
  {
  ...
  },
  {
    ...
    cities: ["Plymouth", "Brockton"],
  },
  {
    name: "Bristol County",
    cities: ["New Bedford", "Fall River"],
  },
  {
    name: "Barnstable / Cape Cod",
    cities: ["Barnstable", "Falmouth", "Hyannis"],
  },
];
...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Fully licensed and insured for residential and commercial work throughout Massachusetts.",
  },
  {
...
const jsonLd = {
  ...
  name: "Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Massachusetts. Custom fabrication and professional installation.",
  url: "https://alpharailings.com/areas/massachusetts",
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-accent">Massachusetts</span>
            </h1>
            <p className="mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl">
              ...
              fabrication and installation throughout Massachusetts — from
              Greater Boston to Cape Cod.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              We serve homeowners, contractors, and businesses across every
      ...
      <section className="py-24 sm:py-32 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold text-foreground tracking-tight">
              What We Offer in Massachusetts
            </h2>
          </div>
