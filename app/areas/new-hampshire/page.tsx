...
export const metadata: Metadata = {
  title: "Glass & Iron Railings in New Hampshire | Alpha Railings",
  description:
    "Premium glass, cable & iron railings in New Hampshire. Custom fabrication and installation in Manchester, Nashua, Portsmouth, and across the state. Free quotes.",
};

const counties = [
  {
    name: "Hillsborough County",
    cities: ["Manchester", "Nashua", "Bedford", "Hudson"],
  },
  {
    name: "Rockingham County",
    cities: ["Portsmouth", "Derry", "Salem", "Exeter", "Hampton"],
  },
  {
    name: "Strafford County",
    cities: ["Dover", "Rochester", "Somersworth", "Durham"],
  },
  {
    name: "Merrimack County",
    cities: ["Concord", "Hooksett", "Pembroke", "Bow"],
  },
  {
    name: "Belknap County",
    cities: ["Laconia", "Gilford", "Belmont"],
  },
];
...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Fully licensed and insured for residential and commercial work throughout New Hampshire.",
  },
  {
...
const jsonLd = {
  ...
  name: "Alpha Railings",
  description:
    "Premium glass, cable & iron railings in New Hampshire. Custom fabrication and professional installation.",
  url: "https://alpharailings.com/areas/new-hampshire",
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-accent">New Hampshire</span>
            </h1>
            <p className="mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl">
              ...
              fabrication and installation throughout New Hampshire — from the
              Seacoast to the Lakes Region.
            </p>
      ...
      <section className="py-24 sm:py-32 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold text-foreground tracking-tight">
              What We Offer in New Hampshire
            </h2>
          </div>
