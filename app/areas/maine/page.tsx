...
export const metadata: Metadata = {
  title: "Glass & Iron Railings in Southern Maine | Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Southern Maine. Custom fabrication and installation in Portland, Scarborough, Biddeford, and across the region. Free quotes.",
};
...
const counties = [
  ...
  {
    name: "York County",
    cities: ["Biddeford", "Saco", "Kennebunk", "Kittery", "York", "Wells"],
  },
  {
    name: "Androscoggin County",
    cities: ["Lewiston", "Auburn"],
  },
];
...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Fully licensed and insured for residential and commercial work throughout Maine.",
  },
  {
    title: "15+ Years Experience",
    description:
      "Over 15 years of railing fabrication and installation across New England.",
  },
  {
...
const jsonLd = {
  ...
  name: "Alpha Railings",
  description:
    "Premium glass, cable & iron railings in Southern Maine. Custom fabrication and professional installation.",
  url: "https://alpharailings.com/areas/maine",
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-accent">Southern Maine</span>
            </h1>
            <p className="mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl">
              ...
              fabrication and installation throughout Southern Maine — from
              Portland to Kittery and beyond.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold text-foreground tracking-tight">
              Where We Work in Southern Maine
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              We serve homeowners, contractors, and businesses across Southern
              Maine&apos;s coastal and inland communities.
            </p>
          </div>
      ...
      <section className="py-24 sm:py-32 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold text-foreground tracking-tight">
              What We Offer in Southern Maine
            </h2>
          </div>
